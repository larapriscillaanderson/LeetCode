...
- [Yanni classical backdrop 😎🎼]... *The Keeper* by Yanni
...
**Today’s Milestones**  
- ✅ Completed: Learned a lot about Docker.
- 📍 In Progress: Want to learn more about using Docker in a real world application.
- 📘 *Tomorrow’s Plan*: Learn about how Docker relates to Ansible and Jenkins
