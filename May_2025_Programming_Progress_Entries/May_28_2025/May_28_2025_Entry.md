...
## 🧠 Learning Objectives  
**Today’s Goal**:  
- Starting to learn about artificial intelligence.
- Add relevant insights to personal knowledge base.

---

## 🧪 Today’s Tools & Resources   
- Intro to AI Google's YouTube video
https://www.youtube.com/watch?v=bknUn7yMwNI
- Intro to Generative AI Google's YouTube video
...
- 🛠️ Architecture Notes:  
    - didn't take many notes today, the YouTube videos were helpful, but I think I need to dive into the full Google Career Certificate course.
...
**Today’s Milestones**  
- ✅ Completed: Intro to AI YouTube videos
- 📍 In Progress: Intro to AI
